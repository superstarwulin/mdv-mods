define('mui/mdv-mods/component/fbpJson',function (require, exports, module) {
...
var Mdv = require('mui/mdv/mdv2'), Common = require('../common/common'), Models = require('../common/models'), Loader = require('../common/loader');
var Component = function (_Mdv) {
        ...
        function Component(mdvIn) {
            ...
            _this.defineModel(true, function (modelName) {
                return mdvIn.getModel('fbpJson').thenOnce(function (json) {
                    ...
                    return onProcess(outport.process, json).thenOnce(function (p_outPorts) {
                        ...
                        if (!model) {
                            throw 'model ' + outport.port + ' not exists';
                        }
                        return model;
                    });
                });
            ...
            function onProcess(name, json) {
                return (modMap[name] = modMap[name] || Mdv.createModel(function (resolve, reject) {
                ...
                }).thenOnce(Component.parseComponent).thenOnce(function (Process) {
                    var p_connections = {}, p_inPorts = new Mdv(), listMap = {}, connections = json.connections;
                    function onConnectionSrc(src) {
                        return onProcess(src.process, json).thenOnce(function (process) {
                            var port = src.port;
                    ...
                    for (var key in p_connections) {
                        ...
                        var indRes, model = p_connections[key].length == 1 ? p_connections[key][0] : Models.mLatest({ models: p_connections[key] }).getModel('out');
        ...
        _createClass(Component, null, [{
                ...
                value: function parseComponent(component) {
                    ...
                    if (comp.length > 1 && /m[A-Z]/.test(comp[1])) {
                        ...
                        return Mdv.createLiteral(comp[0]).thenOnce(Loader.require).then(function (Cls) {
                            return function (mdvIn) {
                                if (!Cls[comp[1]]) {
                                    throw 'method ' + comp[1] + ' not exists';
                                }
                        ...
                        return Mdv.createLiteral(component).thenOnce(Loader.require).then(function (Cls) {
                            return function (mdvIn) {
